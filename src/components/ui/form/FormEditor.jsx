...
const FormEditor = ({ formik, fieldName, delay = 0, label = "" }) => {
	const [editor, setEditor] = useState(null)

	i18nChangeLanguage("en")
	const toolbarConfig = {
		excludeKeys: ["fontFamily", "todo", "emotion", "group-video", "uploadImage"]
	}
	const editorConfig = {
		autoFocus: false
	}
	...
	return (
		<Fragment>
			...
			>
				...
				<div
					className={`formik-editor-wrapper${
				...
				>
					<Toolbar
						...
						mode="default"
						className="formik-editor-toolbar"
					/>
					<Editor
						...
						onChange={(editor) => {
							editor.getHtml() !== "<p><br></p>" &&
								formik.setFieldValue(fieldName, editor.getHtml(), true)
						}}
						mode="default"
						className="formik-editor"
					/>
				</div>
			</motion.div>
			<FormHelperText
